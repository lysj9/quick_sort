...
!	integer(I4B),parameter::MD=10
	...
	public::quick_sort_noidx_seq1
	public::quick_sort_noidx_seq2
	public::quick_sort_widx_seq1
	public::quick_sort_widx_seq2
...
!	real(PC),dimension(:),intent(inout)::a
...
!	real(PC),dimension(:),intent(inout)::a
!	integer(I4B),dimension(:),intent(inout)::idx
	integer(I4B),intent(in)::n
	integer(I4B)::i,j
	integer(I4B)::l,r
	integer(I4B)::jstack
...
!			idx(j)=itemp
	...
	subroutine quick_sort_noidx_seq1(a,n)
	implicit none
	real(PC),dimension(n),intent(inout)::a
	integer(I4B),intent(in)::n
	...
	subroutine quick_sort_noidx_seq2(a,n)
	implicit none
	real(PC),dimension(n),intent(inout)::a
	integer(I4B),intent(in)::n
	...
	subroutine quick_sort_widx_seq1(a,idx,n)
	implicit none
	real(PC),dimension(n),intent(inout)::a
	integer(I4B),dimension(n),intent(inout)::idx
	integer(I4B),intent(in)::n
	...
	subroutine quick_sort_widx_seq2(a,idx,n)
	implicit none
	real(PC),dimension(n),intent(inout)::a
	integer(I4B),dimension(n),intent(inout)::idx
	integer(I4B),intent(in)::n
